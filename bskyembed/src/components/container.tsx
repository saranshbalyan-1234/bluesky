...
export function Container({
  ...
  return (
    <div
      ref={ref}
      className="w-full bg-brand text-black dark:bg-brand relative transition-colors min-w-[300px] flex items-center  dark:text-slate-200 rounded-[20px] cursor-pointer hover:bg-opacity-90"
      onClick={() => {
        if (ref.current && href) {
